...
- Usar URL, credencial y deployment de IA distintos para test y producción. No enviar URLs de base, datos identificatorios innecesarios ni secretos al Polo.
